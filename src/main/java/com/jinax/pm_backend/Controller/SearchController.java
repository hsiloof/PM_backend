...
public class SearchController {
    ...
    public CommonResult<List<Post>> getPostsByTag(String keyword,Integer page,Integer size){
    ...
    public CommonResult<List<Post>> getPostsByAuthor(String author,Integer page,Integer size){
    ...
    public CommonResult<List<Post>> getPostsByNameLike(Double longitude,Double latitude,Double radius,Integer page,Integer size){
    ...
    public CommonResult<List<Post>> getPostByAddress(SearchAddressRequest request){
    ...
    public CommonResult<List<Post>> getTagByNameLike(@RequestParam List<String> tags, Integer page, Integer size){
